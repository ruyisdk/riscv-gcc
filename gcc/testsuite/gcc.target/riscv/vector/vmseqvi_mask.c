...
e16xm1_t test_vmseqvi_mask_e16xm1_uint16xm1 (e16xm1_t merge, uint16xm1_t a, const signed short b, e16xm1_t mask, unsigned int gvl) {
...
e16xm2_t test_vmseqvi_mask_e16xm2_uint16xm2 (e16xm2_t merge, uint16xm2_t a, const signed short b, e16xm2_t mask, unsigned int gvl) {
...
e16xm4_t test_vmseqvi_mask_e16xm4_uint16xm4 (e16xm4_t merge, uint16xm4_t a, const signed short b, e16xm4_t mask, unsigned int gvl) {
...
e16xm8_t test_vmseqvi_mask_e16xm8_uint16xm8 (e16xm8_t merge, uint16xm8_t a, const signed short b, e16xm8_t mask, unsigned int gvl) {
...
e32xm1_t test_vmseqvi_mask_e32xm1_uint32xm1 (e32xm1_t merge, uint32xm1_t a, const signed int b, e32xm1_t mask, unsigned int gvl) {
...
e32xm2_t test_vmseqvi_mask_e32xm2_uint32xm2 (e32xm2_t merge, uint32xm2_t a, const signed int b, e32xm2_t mask, unsigned int gvl) {
...
e32xm4_t test_vmseqvi_mask_e32xm4_uint32xm4 (e32xm4_t merge, uint32xm4_t a, const signed int b, e32xm4_t mask, unsigned int gvl) {
...
e32xm8_t test_vmseqvi_mask_e32xm8_uint32xm8 (e32xm8_t merge, uint32xm8_t a, const signed int b, e32xm8_t mask, unsigned int gvl) {
...
e64xm1_t test_vmseqvi_mask_e64xm1_uint64xm1 (e64xm1_t merge, uint64xm1_t a, const signed long b, e64xm1_t mask, unsigned int gvl) {
...
e64xm2_t test_vmseqvi_mask_e64xm2_uint64xm2 (e64xm2_t merge, uint64xm2_t a, const signed long b, e64xm2_t mask, unsigned int gvl) {
...
e64xm4_t test_vmseqvi_mask_e64xm4_uint64xm4 (e64xm4_t merge, uint64xm4_t a, const signed long b, e64xm4_t mask, unsigned int gvl) {
...
e64xm8_t test_vmseqvi_mask_e64xm8_uint64xm8 (e64xm8_t merge, uint64xm8_t a, const signed long b, e64xm8_t mask, unsigned int gvl) {
...
e8xm1_t test_vmseqvi_mask_e8xm1_uint8xm1 (e8xm1_t merge, uint8xm1_t a, const signed char b, e8xm1_t mask, unsigned int gvl) {
...
e8xm2_t test_vmseqvi_mask_e8xm2_uint8xm2 (e8xm2_t merge, uint8xm2_t a, const signed char b, e8xm2_t mask, unsigned int gvl) {
...
e8xm4_t test_vmseqvi_mask_e8xm4_uint8xm4 (e8xm4_t merge, uint8xm4_t a, const signed char b, e8xm4_t mask, unsigned int gvl) {
...
e8xm8_t test_vmseqvi_mask_e8xm8_uint8xm8 (e8xm8_t merge, uint8xm8_t a, const signed char b, e8xm8_t mask, unsigned int gvl) {
    return vmseqvi_mask_e8xm8_uint8xm8 (merge, a, 1, mask, gvl);
}

/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e16,m1.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e16,m1.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e16,m2.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e16,m2.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e16,m4.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e16,m4.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e16,m8.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e16,m8.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e32,m1.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e32,m1.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e32,m2.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e32,m2.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e32,m4.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e32,m4.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e32,m8.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e32,m8.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e64,m1.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e64,m1.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e64,m2.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e64,m2.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e64,m4.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e64,m4.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e64,m8.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e64,m8.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e8,m1.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e8,m1.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e8,m2.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e8,m2.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e8,m4.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e8,m4.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e8,m8.*vmseq\.vi" } }*/
/* { dg-final { scan-assembler "vsetvli\t\[a-z\]+\[0-9\]+,\[a-z\]+\[0-9\]+,e8,m8.*vmseq\.vi" } }*/
