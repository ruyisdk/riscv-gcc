...
/* { dg-final { scan-assembler "vsetvli\tzero,x0,e32,m1.*vfdiv\.vv" } }*/
/* { dg-final { scan-assembler "vsetvli\tzero,x0,e32,m2.*vfdiv\.vv" } }*/
/* { dg-final { scan-assembler "vsetvli\tzero,x0,e32,m4.*vfdiv\.vv" } }*/
/* { dg-final { scan-assembler "vsetvli\tzero,x0,e32,m8.*vfdiv\.vv" } }*/
/* { dg-final { scan-assembler "vsetvli\tzero,x0,e64,m1.*vfdiv\.vv" } }*/
/* { dg-final { scan-assembler "vsetvli\tzero,x0,e64,m2.*vfdiv\.vv" } }*/
/* { dg-final { scan-assembler "vsetvli\tzero,x0,e64,m4.*vfdiv\.vv" } }*/
/* { dg-final { scan-assembler "vsetvli\tzero,x0,e64,m8.*vfdiv\.vv" } }*/
