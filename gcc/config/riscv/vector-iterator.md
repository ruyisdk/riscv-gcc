...
;; All vector modes supported for quad-widening SEW integer alu.
(define_mode_iterator VQWSIMODES8 [
  VNx8QI VNx16QI VNx32QI VNx64QI
  VNx128QI])

;; Map a vector int or float mode to quad-widening SEW vector mode.
(define_mode_attr VQWSMODE8 [
  (VNx8QI "VNx2SI") (VNx16QI "VNx4SI") (VNx32QI "VNx8SI") (VNx64QI "VNx16SI")
  (VNx128QI "VNx32SI")])
...
;; Map a vector mode to its quad-widening element mode.
