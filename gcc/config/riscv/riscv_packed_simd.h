...
// Packed Merge
CREATE_RVP_INTRINSIC(uint8x4_t, pmerge_u8x4, uint8x4_t, uint8x4_t, uint8x4_t)
CREATE_RVP_INTRINSIC(int8x4_t, pmerge_i8x4, int8x4_t, int8x4_t, uint8x4_t)
CREATE_RVP_INTRINSIC(uint16x2_t, pmerge_u16x2, uint16x2_t, uint16x2_t, uint16x2_t)
CREATE_RVP_INTRINSIC(int16x2_t, pmerge_i16x2, int16x2_t, int16x2_t, uint16x2_t)
CREATE_RVP_INTRINSIC(uint8x8_t, pmerge_u8x8, uint8x8_t, uint8x8_t, uint8x8_t)
CREATE_RVP_INTRINSIC(int8x8_t, pmerge_i8x8, int8x8_t, int8x8_t, uint8x8_t)
CREATE_RVP_INTRINSIC(uint16x4_t, pmerge_u16x4, uint16x4_t, uint16x4_t, uint16x4_t)
CREATE_RVP_INTRINSIC(int16x4_t, pmerge_i16x4, int16x4_t, int16x4_t, uint16x4_t)
CREATE_RVP_INTRINSIC(uint32x2_t, pmerge_u32x2, uint32x2_t, uint32x2_t, uint32x2_t)
CREATE_RVP_INTRINSIC(int32x2_t, pmerge_i32x2, int32x2_t, int32x2_t, uint32x2_t)
...
// Packed Saturation
CREATE_RVP_INTRINSIC(uint16x2_t, pusati_u16x2, int16x2_t, uint32_t)
CREATE_RVP_INTRINSIC(int16x2_t, psati_i16x2, int16x2_t, uint32_t)
CREATE_RVP_INTRINSIC(uint16x4_t, pusati_u16x4, int16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(uint32x2_t, pusati_u32x2, int32x2_t, uint32_t)
CREATE_RVP_INTRINSIC(int16x4_t, psati_i16x4, int16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(int32x2_t, psati_i32x2, int32x2_t, uint32_t)
...
CREATE_RVP_INTRINSIC(uint8x8_t, psrl_s_u8x8, uint8x8_t, uint32_t)
CREATE_RVP_INTRINSIC(uint16x4_t, psrl_s_u16x4, uint16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(uint32x2_t, psrl_s_u32x2, uint32x2_t, uint32_t)
CREATE_RVP_INTRINSIC(int8x8_t, psra_s_i8x8, int8x8_t, uint32_t)
CREATE_RVP_INTRINSIC(int16x4_t, psra_s_i16x4, int16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(int32x2_t, psra_s_i32x2, int32x2_t, uint32_t)
...
CREATE_RVP_INTRINSIC(int16x4_t, psshar_s_i16x4, int16x4_t, int32_t)
CREATE_RVP_INTRINSIC(int32x2_t, psshar_s_i32x2, int32x2_t, int32_t)
CREATE_RVP_INTRINSIC(uint16x4_t, psshl_s_u16x4, uint16x4_t, int32_t)
CREATE_RVP_INTRINSIC(uint32x2_t, psshl_s_u32x2, uint32x2_t, int32_t)
CREATE_RVP_INTRINSIC(uint16x4_t, psshlr_s_u16x4, uint16x4_t, int32_t)
CREATE_RVP_INTRINSIC(uint32x2_t, psshlr_s_u32x2, uint32x2_t, int32_t)
...
CREATE_RVP_INTRINSIC(int32x2_t, pwadda_i32x2, int32x2_t, int16x2_t, int16x2_t)
CREATE_RVP_INTRINSIC(uint16x4_t, pwaddau_u16x4, uint16x4_t, uint8x4_t, uint8x4_t)
CREATE_RVP_INTRINSIC(uint32x2_t, pwaddau_u32x2, uint32x2_t, uint16x2_t, uint16x2_t)
CREATE_RVP_INTRINSIC(int16x4_t, pwsuba_i16x4, int16x4_t, int8x4_t, int8x4_t)
CREATE_RVP_INTRINSIC(int32x2_t, pwsuba_i32x2, int32x2_t, int16x2_t, int16x2_t)
CREATE_RVP_INTRINSIC(uint16x4_t, pwsubau_u16x4, uint16x4_t, uint8x4_t, uint8x4_t)
CREATE_RVP_INTRINSIC(uint32x2_t, pwsubau_u32x2, uint32x2_t, uint16x2_t, uint16x2_t)

// Packed Widening Shift (RV32-only; RV64 TODO)
CREATE_RVP_INTRINSIC(uint16x4_t, pwsll_s_u16x4, uint8x4_t, uint32_t)
CREATE_RVP_INTRINSIC(uint32x2_t, pwsll_s_u32x2, uint16x2_t, uint32_t)
CREATE_RVP_INTRINSIC(int16x4_t, pwsla_s_i16x4, int8x4_t, uint32_t)
CREATE_RVP_INTRINSIC(int32x2_t, pwsla_s_i32x2, int16x2_t, uint32_t)

// Packed Narrowing Shift (RV32-only; RV64 TODO)
CREATE_RVP_INTRINSIC(uint8x4_t, pnsrl_s_u8x4, uint16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(uint16x2_t, pnsrl_s_u16x2, uint32x2_t, uint32_t)
CREATE_RVP_INTRINSIC(int8x4_t, pnsra_s_i8x4, int16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(int16x2_t, pnsra_s_i16x2, int32x2_t, uint32_t)
CREATE_RVP_INTRINSIC(int8x4_t, pnsrar_s_i8x4, int16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(int16x2_t, pnsrar_s_i16x2, int32x2_t, uint32_t)

// Packed Narrowing Clip (RV32-only; RV64 TODO)
CREATE_RVP_INTRINSIC(uint8x4_t, pnclipu_s_u8x4, uint16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(uint16x2_t, pnclipu_s_u16x2, uint32x2_t, uint32_t)
CREATE_RVP_INTRINSIC(uint8x4_t, pnclipru_s_u8x4, uint16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(uint16x2_t, pnclipru_s_u16x2, uint32x2_t, uint32_t)
CREATE_RVP_INTRINSIC(int8x4_t, pnclip_s_i8x4, int16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(int16x2_t, pnclip_s_i16x2, int32x2_t, uint32_t)
CREATE_RVP_INTRINSIC(int8x4_t, pnclipr_s_i8x4, int16x4_t, uint32_t)
CREATE_RVP_INTRINSIC(int16x2_t, pnclipr_s_i16x2, int32x2_t, uint32_t)
#endif
...
// Packed Multiply High 64-bit i32x2 (RV64 single pmulh.w; RV32 2x scalar TODO)
#if __riscv_xlen == 64
...
// i16x2 (both ISAs), i16x4 (RV64 single, RV32 2x), i32x2 (RV64 single, RV32 TODO)
CREATE_RVP_INTRINSIC(int16x2_t, pmhacc_i16x2, int16x2_t, int16x2_t, int16x2_t)
CREATE_RVP_INTRINSIC(int16x2_t, pmhracc_i16x2, int16x2_t, int16x2_t, int16x2_t)
CREATE_RVP_INTRINSIC(uint16x2_t, pmhaccu_u16x2, uint16x2_t, uint16x2_t, uint16x2_t)
CREATE_RVP_INTRINSIC(uint16x2_t, pmhraccu_u16x2, uint16x2_t, uint16x2_t, uint16x2_t)
CREATE_RVP_INTRINSIC(int16x2_t, pmhaccsu_i16x2, int16x2_t, int16x2_t, uint16x2_t)
CREATE_RVP_INTRINSIC(int16x2_t, pmhraccsu_i16x2, int16x2_t, int16x2_t, uint16x2_t)
#if __riscv_xlen == 64
CREATE_RVP_INTRINSIC(int16x4_t, pmhacc_i16x4, int16x4_t, int16x4_t, int16x4_t)
CREATE_RVP_INTRINSIC(int16x4_t, pmhracc_i16x4, int16x4_t, int16x4_t, int16x4_t)
CREATE_RVP_INTRINSIC(uint16x4_t, pmhaccu_u16x4, uint16x4_t, uint16x4_t, uint16x4_t)
CREATE_RVP_INTRINSIC(uint16x4_t, pmhraccu_u16x4, uint16x4_t, uint16x4_t, uint16x4_t)
CREATE_RVP_INTRINSIC(int16x4_t, pmhaccsu_i16x4, int16x4_t, int16x4_t, uint16x4_t)
CREATE_RVP_INTRINSIC(int16x4_t, pmhraccsu_i16x4, int16x4_t, int16x4_t, uint16x4_t)
CREATE_RVP_INTRINSIC(int32x2_t, pmhacc_i32x2, int32x2_t, int32x2_t, int32x2_t)
CREATE_RVP_INTRINSIC(int32x2_t, pmhracc_i32x2, int32x2_t, int32x2_t, int32x2_t)
CREATE_RVP_INTRINSIC(uint32x2_t, pmhaccu_u32x2, uint32x2_t, uint32x2_t, uint32x2_t)
CREATE_RVP_INTRINSIC(uint32x2_t, pmhraccu_u32x2, uint32x2_t, uint32x2_t, uint32x2_t)
CREATE_RVP_INTRINSIC(int32x2_t, pmhaccsu_i32x2, int32x2_t, int32x2_t, uint32x2_t)
CREATE_RVP_INTRINSIC(int32x2_t, pmhraccsu_i32x2, int32x2_t, int32x2_t, uint32x2_t)
#endif

// Packed Q-format Multiplication (i16x2/i16x4 both ISAs; i32x2 RV64-only, RV32 2x TODO)
...
// h-series i32 (both ISAs): RV32 mqacc.h*/mqracc.h*, RV64 pmqacc.w.h*/pmqracc.w.h*
...
// h-series i32x2 (packed): RV64 pmqacc.w.h*/pmqracc.w.h*, RV32 2x mqacc.h*/mqracc.h*
CREATE_RVP_INTRINSIC(int32x2_t, pmqacc_h00_i32x2, int32x2_t, int16x4_t, int16x4_t)
CREATE_RVP_INTRINSIC(int32x2_t, pmqacc_h01_i32x2, int32x2_t, int16x4_t, int16x4_t)
CREATE_RVP_INTRINSIC(int32x2_t, pmqacc_h11_i32x2, int32x2_t, int16x4_t, int16x4_t)
CREATE_RVP_INTRINSIC(int32x2_t, pmqracc_h00_i32x2, int32x2_t, int16x4_t, int16x4_t)
CREATE_RVP_INTRINSIC(int32x2_t, pmqracc_h01_i32x2, int32x2_t, int16x4_t, int16x4_t)
CREATE_RVP_INTRINSIC(int32x2_t, pmqracc_h11_i32x2, int32x2_t, int16x4_t, int16x4_t)
...
// b-series i16x2 (both ISAs, single insn): pmul.h.bNN/pmulu.h.bNN/pmulsu.h.bNN
...
// h-series i32 (scalar): RV32 mul.hNN/mulu.hNN/mulsu.hNN; RV64 pmul.w.hNN/etc
...
// h-series i32 (both ISAs): RV32 macc.h*/maccu.h*/maccsu.h*, RV64 pmacc.w.h*/etc
...
// h-series i32x2 (packed): RV64 pmacc.w.h*/etc, RV32 2x macc.h*/etc
